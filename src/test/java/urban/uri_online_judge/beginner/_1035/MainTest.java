...
public class MainTest {
	...
	public void shouldValidateSelectionTestBranch1() throws IOException {
		String inputSample = new SampleBuilder().append(0).append(1).append(1).append(2).build();
		InputStream input = this.inputStream.build(inputSample);
	...
	public void shouldValidateSelectionTestBranch2() throws IOException {
		String inputSample = new SampleBuilder().append(0).append(2).append(1).append(0).build();
		InputStream input = this.inputStream.build(inputSample);
	...
	public void shouldValidateSelectionTestBranch3() throws IOException {
		String inputSample = new SampleBuilder().append(2).append(2).append(1).append(2).build();
		InputStream input = this.inputStream.build(inputSample);
	...
	public void shouldValidateSelectionTestBranch6() throws IOException {
		String inputSample = new SampleBuilder().append(1).append(2).append(1).append(2).build();
		InputStream input = this.inputStream.build(inputSample);
